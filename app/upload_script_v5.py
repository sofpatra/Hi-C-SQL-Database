...
# --- CONFIG --- 
HICEXPLORER_CMD = "/usr/local/Python-3.12/bin/hicConvertFormat"  # Replace with the path to hicConvertFormat on your system
OUTPUT_DIR = "app/samples" #replace with full path to you samples directory
os.makedirs(OUTPUT_DIR, exist_ok=True)

DB_USER = #####  # replace with your MariaDB username
DB_PASS = #####  # replace with your MariaDB password
DB_HOST = ##### # replace with your MariaDB host
DB_NAME = ##### # replace with your MariaDB database name
DB_PORT = ##### # replace with your MariaDB port
